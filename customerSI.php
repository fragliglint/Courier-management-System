...
<body>
    <h1 align='center' style="margin: 15px; color:seagreen;font-weight: bold;font-family:'Times New Roman', Times, serif">Fast COURIER SERVICE</h1>
    <hr />
            ...
            <div class="col-md-12">
                ...
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <a href="resetpswd.php" class="btn btn-danger">Reset Password</a>
                    </div>
